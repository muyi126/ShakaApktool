...
public class MainOld2 extends HelpAndLanguageCommand {
//    public static final String VERSION = loadVersion();
    ...
    private static String loadVersion() {
        ...
        try(
                InputStream propertiesStream = MainOld2.class.getClassLoader().getResourceAsStream("properties/shaka.properties")
                ) {
    ...
    public static void main(String[] args) {
        ...
        CommandUtil.modifyAnnotationValue(MainOld2.class.getAnnotation(ExtendedParameters.class),
