...
public class Main {
    public static void main(String[] args) throws IOException, InterruptedException, BrutException {
        ...
        brut.apktool.Main.Verbosity verbosity = brut.apktool.Main.Verbosity.NORMAL;
        ...
        if (commandLine.hasOption("-v") || commandLine.hasOption("--verbose")) {
            verbosity = brut.apktool.Main.Verbosity.VERBOSE;
        } else if (commandLine.hasOption("-q") || commandLine.hasOption("--quiet")) {
            verbosity = brut.apktool.Main.Verbosity.QUIET;
        }
    ...
    private static void setupLogging(final brut.apktool.Main.Verbosity verbosity) {
        ...
        if (verbosity == brut.apktool.Main.Verbosity.QUIET) {
            return;
        }
                ...
                try {
                    ...
                    if (record.getLevel().intValue() >= Level.WARNING.intValue()) {
                        ...
                        if (record.getLevel().intValue() >= Level.INFO.intValue()) {
                            ...
                            if (verbosity == brut.apktool.Main.Verbosity.VERBOSE) {
                                System.out.write(message.getBytes());
                            }
                        }
                    }
